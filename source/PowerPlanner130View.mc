...
class PowerPlanner130View extends WatchUi.DataField
{
    ...
    function compute(info as Activity.Info) as Void
    {
        ...
        var alpha = _filteredPower > 0 ? 0.85f : 0.0f;
